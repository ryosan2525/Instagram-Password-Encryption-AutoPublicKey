...
// --- TweetNaCl.js Wrapper ---
const tweetnaclModule = (function() {
    const module = { exports: {} };
    const exports = module.exports;
    // shim require for crypto if tweetnacl uses it
    const require = (name) => {
        if (name === 'crypto') return nodeCrypto;
        throw new Error("Unknown require in tweetnacl: " + name);
    };
...
const utilsModule = (function() {
    ...
    // Mock require to inject our local modules
    const require = (name) => {
        if (name === './blake') return blakeModule;
        if (name === './tweetnacl') return tweetnaclModule;
        throw new Error("Unknown require in utils: " + name);
    };
...
const indexModule = (function() {
    ...
    const require = (name) => {
        if (name === './helpers/utils') return utilsModule;
        if (name === 'crypto') return { webcrypto: nodeCrypto.webcrypto };
        throw new Error("Unknown require in index: " + name);
    };
